...
public final class PerAppsPropsUtils {
    ...
    private static final String TAG = "PerAppsPropsUtils";
    ...
    static {
        ...
        propsToChange.put("IFT50P", createIFT50PProps());
        ...
        propsToChange.put("RM11P", createRM11PProps());
    ...
    private static Map<String, Object> createIFT50PProps() {
        Map<String, Object> props = new HashMap<>();
        props.put("BRAND", "INFINIX");
        props.put("DEVICE", "INFINIX GT 50 PRO 5G");
        props.put("MANUFACTURER", "INFINIX");
        props.put("MODEL", "Infinix X6891");
        props.put("FINGERPRINT", "Infinix/X6891/Infinix GT 50 Pro 5G:15/AP3A.240617.008/20250520.123456:user/release-keys");
        props.put("PRODUCT", "X6891");
        return props;
    }
    ...
    private static Map<String, Object> createRM11PProps() {
        Map<String, Object> props = new HashMap<>();
        props.put("BRAND", "REDMAGIC");
        props.put("DEVICE", "REDMAGIC 11 PRO");
        props.put("MANUFACTURER", "Nubia");
        props.put("MODEL", "NX809J");
        props.put("FINGERPRINT", "REDMAGIC/NX809J-UN/NX809J:16/BP2A.250605.031.A3/20251017.000000:user/release-keys");
        props.put("PRODUCT", "NX809J");
        return props;
    }
    ...
    public static void setProps(Context context) {
        ...
        try {
            ...
            dlog("PerAppsPropsUtils: Failed to read spoofed apps setting: " + e.getMessage());
            return;
        }
        ...
        try {
            ...
            dlog("PerAppsPropsUtils: Failed to parse custom profiles: " + e.getMessage());
        }
