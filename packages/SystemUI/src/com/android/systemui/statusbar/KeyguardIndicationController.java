    ...
    protected final void updateDeviceEntryIndication(boolean animate) {
        ...
        if (mDozing) {
            ...
            if (!TextUtils.isEmpty(mBiometricMessage)) {
                ...
                String batteryTemp = com.android.internal.util.crdroid.ThemeUtils.batteryTemperature(mContext, false);
                String cpuTemp = com.android.internal.util.crdroid.ThemeUtils.getCPUTemp(mContext);
