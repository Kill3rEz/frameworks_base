...
public class SecureSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(Secure.STATUS_BAR_BLUETOOTH_BATTERY, BOOLEAN_VALIDATOR);
        ...
        VALIDATORS.put(Secure.DOZE_SHAKE_TO_SHOW, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.DOZE_SHAKE_TO_SHOW_DURATION, NON_NEGATIVE_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.DOZE_SHAKE_INTENSITY, NON_NEGATIVE_INTEGER_VALIDATOR);
        ...
        VALIDATORS.put(Secure.DUAL_SHADE_LANDSCAPE, BOOLEAN_VALIDATOR);
